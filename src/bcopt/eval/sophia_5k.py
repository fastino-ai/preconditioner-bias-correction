"""Evaluate saved Sophia std/full checkpoints on the 5000-example holdout."""
...
from bcopt.trainers.sophia_sft import evaluate, set_seed, tokenize_example


MODEL_NAME = "Qwen/Qwen2.5-0.5B"
SEQ_LEN = 1024
EVAL_BATCH_SIZE = 8
OUT_DIR = Path("../runs/sophia_cm_bc_full_b512_lr2e-5_m8_detached_v2")
CKPTS = [
    ("std", Path("../runs/sophia_cm_std512_m8/std_model")),
...
def main():
    ...
    print("=== Sophia 5000-example eval ===", flush=True)
