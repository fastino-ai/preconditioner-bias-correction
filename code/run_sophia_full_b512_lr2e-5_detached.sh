...
RUN_DIR="../runs/sophia_cm_bc_full_b512_lr2e-5_m8_detached"
LOG="$RUN_DIR/log.txt"
...
python3 -u plot_results.py --run_dir "$RUN_DIR" --optimizer "Sophia-G CM b512 FULL BC lr=2e-5 vs std lr=2e-5" 2>&1 | tee -a "$LOG"
[[ "$ec" -eq 0 ]] || exit 1
