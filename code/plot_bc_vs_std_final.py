"""Plot training-loss curves + held-out eval bar for BC LOO+Jensen vs std AdamW
on the FineWeb-Edu pretraining run."""
import json
...
STD_DIR = ROOT / "runs" / "adamw_pretrain_std_b512_lr6e-4_v2"
BC_DIR = ROOT / "runs" / "adamw_pretrain_loo_hybrid_sqm_jensen_b512_emb6e-4_dense9e-4_floor0.2"
...
out_path = ROOT / "runs" / "bc_vs_std_final.png"
